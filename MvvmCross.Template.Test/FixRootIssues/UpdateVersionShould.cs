...
{
    public class UpdateVersionShould
    {
        public UpdateVersionShould(ITestOutputHelper output) => _output = output;



        #region Test Update Mvx Version
        [Fact]
        [Trait("Task", "Fix root")]
        ...
        #region Test Update Template Version
        [Fact]
        [Trait("Task", "Fix root")]
